        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[80vh] flex flex-col">
            ...
            <div className="px-6 py-4 border-b border-gray-200">
              <h2 className="text-xl font-bold">Select Directory</h2>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {browserLoading ? (
                ...
                <div className="text-red-600 py-4">{browserError}</div>
              ) : (
                <>
                  {/* Current Path */}
                  <div className="mb-4">
                    ...
                    <div className="px-3 py-2 bg-gray-100 border border-gray-300 rounded-md text-sm font-mono break-all">
                  ...
                  {browserData.parentPath && (
                    <button
                      ...
                      className="w-full mb-2 px-4 py-2 text-left bg-gray-50 hover:bg-gray-100 border border-gray-300 rounded-md flex items-center gap-2"
                    >
                      <span>↑</span>
                    ...
                    {browserData.directories.length === 0 ? (
                      ...
                      browserData.directories.map((dir) => (
                        <button
                          ...
                          className="w-full px-4 py-2 text-left hover:bg-gray-50 border border-gray-200 rounded-md flex items-center gap-2"
                        >
                          <span>📁</span>
